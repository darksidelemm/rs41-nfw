...
typedef asn1SccSint horusTemperatureSensors_internal;

typedef asn1SccSint horusTemperatureSensors_external;

typedef asn1SccSint horusTemperatureSensors_custom1;

typedef asn1SccSint horusTemperatureSensors_custom2;
...
typedef asn1SccUint horusMilliVoltSensors_battery;

typedef asn1SccUint horusMilliVoltSensors_solar;

typedef asn1SccUint horusMilliVoltSensors_custom1;

typedef asn1SccUint horusMilliVoltSensors_custom2;
...
typedef asn1SccUint horusTelemetry_sequenceNumber;

typedef asn1SccSint horusTelemetry_timeOfDaySeconds;

typedef asn1SccSint horusTelemetry_latitude;

typedef asn1SccSint horusTelemetry_longitude;

typedef asn1SccSint horusTelemetry_altitudeMeters;

typedef asn1SccUint horusTelemetry_velocityHorizontalKilometersPerHour;

typedef asn1SccUint horusTelemetry_gnssSatellitesVisible;
